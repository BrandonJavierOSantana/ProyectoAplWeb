...
@Entity
@Table(name = "Direccion", schema = "dbo")
open class Direccion {
    ...
    open var idEstado: mx.com.ProyectoBasico.ConsultasGen.Esp.tecnm.ProyectoFinalConsultasGeneralesYEspecialidad.Entity.DireccionEstado? = null
}